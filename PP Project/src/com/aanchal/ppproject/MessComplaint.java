 ...
 */
public class MessComplaint extends JFrame implements ActionListener{
    ...
    MessComplaint(){
        ...
        r1=new JRadioButton("Food");
        r2=new JRadioButton("Water");
        r3=new JRadioButton("Cleaning");
        r4=new JRadioButton("Mess Menu");
    ...
    public void actionPerformed(ActionEvent e) {
        if(e.getSource()==submit){
               ...
               if(r1.isSelected()){
                   try {
                       Dbconnect.foodComplaint(complaint.getText());
                   } catch (SQLException ex) {
                       Logger.getLogger(MessComplaint.class.getName()).log(Level.SEVERE, null, ex);
                   }
               }
               else  if(r2.isSelected()){
                   try {
                       Dbconnect.MesswaterComplaint(complaint.getText());
                   } catch (SQLException ex) {
                       Logger.getLogger(MessComplaint.class.getName()).log(Level.SEVERE, null, ex);
                   }
                   ...
                   try {
                       Dbconnect.MessCleaningComplaint(complaint.getText());
                   } catch (SQLException ex) {
                       Logger.getLogger(MessComplaint.class.getName()).log(Level.SEVERE, null, ex);
                   }
                   ...
                   try {
                       Dbconnect.messMenuComplaint(complaint.getText());
                   } catch (SQLException ex) {
                       Logger.getLogger(MessComplaint.class.getName()).log(Level.SEVERE, null, ex);
                   }
